...
@Tag(name = "Estados de reserva", description = "Operaciones para gestionar los estados de las reservas")
public class EstadoReservaController {
    ...
    public ResponseEntity<CollectionModel<EntityModel<EstadoReservaDTO>>> findAll() {
        ...
        return ResponseEntity.ok(CollectionModel.of(estados,
                linkTo(methodOn(EstadoReservaController.class).findAll()).withSelfRel()));
    }
    ...
    public ResponseEntity<EntityModel<EstadoReservaDTO>> save(
        ...
        return ResponseEntity
                .created(linkTo(methodOn(EstadoReservaController.class).findById(estadoCreado.getId())).toUri())
