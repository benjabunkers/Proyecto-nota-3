...
@Tag(name = "Direcciones", description = "Operaciones para gestionar direcciones de clientes")
public class DireccionController {
    ...
    public ResponseEntity<CollectionModel<EntityModel<DireccionDTO>>> findAll() {
        ...
        return ResponseEntity.ok(CollectionModel.of(direcciones,
                linkTo(methodOn(DireccionController.class).findAll()).withSelfRel()));
    }
    ...
    public ResponseEntity<EntityModel<DireccionDTO>> save(
        ...
        return ResponseEntity
                .created(linkTo(methodOn(DireccionController.class).findById(direccionCreada.getId())).toUri())
